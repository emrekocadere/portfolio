      ...
      <div className="max-w-[1100px] mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div 
              key={project.id} 
              className="bg-[#16161f] border border-primary-500/15 rounded-2xl p-8 hover:border-primary-500/40 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary-500/15 transition-all"
            >
              ...
              <div className="flex gap-3 pt-6 border-t border-primary-500/15">
                <a 
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium bg-[#12121c] border border-primary-500/15 text-gray-400 hover:bg-[#1c1c2a] hover:border-primary-500 hover:text-primary-500 hover:-translate-y-0.5 transition-all"
                >
                ...
                {project.live && (
                  <a 
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg text-sm font-medium bg-primary-500/10 border border-primary-500 text-primary-500 hover:bg-primary-500 hover:text-white hover:-translate-y-0.5 transition-all"
                  >
